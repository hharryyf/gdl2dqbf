...
next(cell(X35226, X35227, X35228)) :- true(cell(X35226, X35227, X35228)), X35228 != bnot terminal, domdomain(2, X35226), domdomain(2, X35227), domdomain(3, X35228).
next(cell(X35226, X35227, b)) :- does(X35232, mark(X35235, X35236)), true(cell(X35226, X35227, b)), 1 { X35226 != X35235distinct ; X35227 != X35236distinct }domdomain(4, X35232), domdomain(2, X35235), domdomain(2, X35236), not terminal, domdomain(2, X35226), domdomain(2, X35227).
